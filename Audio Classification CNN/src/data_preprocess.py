...
def log_scale_melspectrogram(path, plot=False):
    ...
    #print("here i am printing++++++++++++++++++++++++++++++=",n_sample,n_sample_fit)
    ...
    #logamplitude
    melspect = lb.amplitude_to_db(lb.feature.melspectrogram(y=signal, sr=Fs, hop_length=N_OVERLAP, n_fft=N_FFT, n_mels=N_MELS)**2)#, ref_power=1.0
