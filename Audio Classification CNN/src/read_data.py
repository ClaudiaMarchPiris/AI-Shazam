...
def get_labels(labels_dense=labels['label'], num_classes=30):
...
def get_melspectrograms(labels_dense=labels, num_classes=30):
...
def get_melspectrograms_indexed(index, labels_dense=labels, num_classes=30):
